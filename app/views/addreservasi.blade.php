...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Tambah Data Reservasi</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Tambah Data Reservasi UKM Kesenian Bali
                        </div>
                                ...
                                <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            {{ Form::label('jumlah', 'Jumlah Barang') }}
                                                {{ Form::number('jumlah', Input::old('jumlah'), array('class' => 'form-control')) }}
                                        </div>
                                        <div class="form-group">
                                            {{ Form::label('ormawa', 'Ormawa') }}
                                            {{ Form::text('ormawa', Input::old('ormawa'), array('class' => 'form-control')) }}
                                        </div>
                                        <div class="form-group">
                                            {{ Form::label('kode', 'Kode Barang') }}
                                         {{ Form::text('kode', Input::old('kode'), array('class' => 'form-control')) }}
                                        </div>
